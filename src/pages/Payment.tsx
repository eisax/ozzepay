                    ...
                    <Tabs defaultValue="utilities" className="w-full">
                        ...
                        <TabsContent value="mobile" className="space-y-6">
                            ...
                            <form onSubmit={handlePayment} className="space-y-4 pt-4 border-t">
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                    ...
                                    <div className="space-y-2">
                                        <Label htmlFor="mobile-amount">Amount (USD)</Label>
                        ...
                        <TabsContent value="internet" className="space-y-6">
                            ...
                            <form onSubmit={handlePayment} className="space-y-4 pt-4 border-t">
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                    <div className="space-y-2">
                                        <Label htmlFor="internet-wallet">From Wallet</Label>

                                        <Select
                                            value={selectedWallet}
                                            onValueChange={setSelectedWallet}
                                        >
                                            <SelectTrigger id="internet-wallet">
                                                <SelectValue placeholder="Select wallet" />
                                            </SelectTrigger>
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                    <div className="space-y-2">
                                        ...
                                        >
                                            ...
                                            <SelectTrigger id="other-wallet"></SelectTrigger>
                                        </Select>
                                    </div>
                                </div>
                            </form>
